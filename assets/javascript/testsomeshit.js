function weatherBackground() {
    ...
    } else if (response.weather.id === 803 || 804) {
        var overcastImage = $("<img>");
        overcastImage.attr("src", "../images/weather/overcast.jpg");
